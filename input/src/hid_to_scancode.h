...
uint8_t ascii2scancode(uint8_t ascii) {
  // Basic ASCII to PS/2 scancode conversion
  static const uint8_t ascii_to_scancode[] = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // 0x00-0x07
    0x0E, 0x0F, 0x1C, 0x00, 0x00, 0x00, 0x00, 0x00, // 0x08-0x0F (backspace, tab, Enter)
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // 0x10-0x17
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // 0x18-0x1F
    0x39, 0x02, 0x28, 0x04, 0x05, 0x06, 0x08, 0x28, // 0x20-0x27 (space, !, ", #, $, %, &, ')
    0x0A, 0x0B, 0x09, 0x0D, 0x33, 0x0C, 0x34, 0x35, // 0x28-0x2F ((, ), *, +, comma, -, ., /)
    0x0B, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, // 0x30-0x37 (0-7)
    0x09, 0x0A, 0x00, 0x27, 0x33, 0x0D, 0x34, 0x35, // 0x38-0x3F (8, 9, :, ;, <, =, >, ?)
    0x03, 0x1E, 0x30, 0x2E, 0x20, 0x12, 0x21, 0x22, // 0x40-0x47 (@, A-G)
    0x23, 0x17, 0x24, 0x25, 0x26, 0x32, 0x31, 0x18, // 0x48-0x4F (H-O)
    0x19, 0x10, 0x13, 0x1F, 0x14, 0x16, 0x2F, 0x11, // 0x50-0x57 (P-W)
    0x2D, 0x15, 0x2C, 0x1A, 0x2B, 0x1B, 0x07, 0x0C, // 0x58-0x5F (X-Z, [, \, ], ^, _)
    0x29, 0x1E, 0x30, 0x2E, 0x20, 0x12, 0x21, 0x22, // 0x60-0x67 (`, a-g)
    0x23, 0x17, 0x24, 0x25, 0x26, 0x32, 0x31, 0x18, // 0x68-0x6F (h-o)
    0x19, 0x10, 0x13, 0x1F, 0x14, 0x16, 0x2F, 0x11, // 0x70-0x77 (p-w)
    0x2D, 0x15, 0x2C, 0x1A, 0x2B, 0x1B, 0x29, 0x00  // 0x78-0x7F (x-z, {, |, }, ~, DEL)
  };
  
  if (ascii < sizeof(ascii_to_scancode)) {
    return ascii_to_scancode[ascii];
  }
  return 0;
}
